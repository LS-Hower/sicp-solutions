...
@section{练习 1.12 | @racket[binomial] ：计算杨辉三角}
...
@section[#:tag "exercise 1.16"]{练习 1.16 | @racket[fast-expt-iter] ：快速幂，而且迭代}
...
@section{练习 1.17 | @racket[doubling-*] ：“快速乘”}
...
@section{练习 1.18 | @racket[doubling-*-iter] ：“快速乘”，甚至迭代}

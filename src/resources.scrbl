...
@itemlist[@item{@hyperlink["https://download.racket-lang.org/"]{Racket} ：工具链成熟，其中就包含集成开发环境 DrRacket。安装方便。但在语言细节上和书中的 Scheme 不同之处略多一些（但也都不难克服）。本站 @hyperlink["./additional-lisp.html"]{补充的 Lisp 知识} 页面对差异做了讲解。本项目也使用了 Racket 工具链和语言。}

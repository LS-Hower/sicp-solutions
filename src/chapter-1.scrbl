...
@margin-note{@racket[(list 0 1 2 3 4)] 创建一个列表，包含 @racket[0] 、 @racket[1] 、 @racket[2] 、 @racket[3] 、 @racket[4] 这 5 个元素。 @racket[(map f (list 0 1 2 3 4))] 能够将 @racket[f] 函数应用于列表中的每个元素，相当于 @racket[(list (f 0) (f 1) (f 2) (f 3) (f 4))] ，从而能够将所有结果一次性全部打印出来。这样可以避免交互次数太多，影响阅读体验。}

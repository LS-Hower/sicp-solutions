...
@itemlist[@item{@hyperlink["https://download.racket-lang.org/"]{Racket}}
          @item{@hyperlink["https://github.com/cisco/ChezScheme/releases"]{Chez Scheme 解释器}}
          @item{@hyperlink["https://try.scheme.org/"]{Scheme 官网的在线解释器（无需下载）}}]
...
Racket 和 Chez Scheme 都支持大整数类型，所以不必担心整数溢出等问题。例如，可以轻易计算出 @(use-mathjax) @${2^{256}} 的值：

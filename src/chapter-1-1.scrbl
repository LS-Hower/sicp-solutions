...
@section{练习 1.7 | @racket[good-enough?] 过程可以更好}
...
TODO “对于很大和很小的数，这一方式都能工作吗？”

@; ----------------------------------------------------------------------

@section{练习 1.8 | 牛顿法求立方根}
